...
export const Background = () => {
  ...
  return (
    <div
      className={`after:to-background absolute top-0 left-0 -z-20 h-full max-h-[1080px] w-full bg-linear-to-b from-transparent to-red-500 after:absolute after:top-0 after:left-0 after:-z-10 after:h-full after:max-h-[1080px] after:w-full after:bg-linear-to-b after:from-transparent ${theme === "dark" && "opacity-15"}`}
      style={{
